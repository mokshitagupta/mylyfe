...
import "../../Alert.css";
import SpanishGoalDetailsModal from "./SpanishGoalDetailsModal.jsx";
...
export default class SpanishMyGoals extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showModal: false,
  ...
  async handleGoalSubmit() {
    ...
    if (this.state.goalTitle == "") {
      ...
      this.setState({error: "Por favor agregue un título."})
      return
    }
    if (this.state.goalDate == "") {
      this.setState({isError: true});
      this.setState({error: "Por favor agregue una fecha."});
      return
    }
    ...
    return (
      ...
      <div className="myGoals">
        ...
        <div className = "goalsuccess">
            <Alert id="error" color={this.state.isError ? "green" : ""} text={this.state.error}/>
        </div>
        
        <div className = "goalblock" id="achieve">
          <h18 className="currentNum-text">Metas a lograr</h18>
          <h1 className="currentNum-number">{numGoalsToAcheive}</h1>
          </div>
          <div className="user-info-goals">
            <SpanishUserInfo points = {parseInt(this.state.points)} uploaderID={localStorage.getItem("user")} ismyprofile={this.state.ismyprofile} mode={false}/>
          ...
          <div className = "goalblock" id="completed">
            <h18 className="completedNum-text">Metas Cumplidas</h18>
        ...
        <div className = "mygoalsblock">
          ...
          <div className = "progress-goals" id = "title">
          <img src = {bloom} alt = "blooming icon" id = "bloom"/><h19>Próximos Metas</h19>
          </div>
