...
class SpanishGetEmail extends React.Component {
    constructor(input){
        super(input);
        this.state = {
            email: "",
        ...
        return (
            <div className = "submitEmail">
                ...
                <form className = "email-form" onSubmit={this.doSubmit}>
                    <input type = "email" className = "getEmail" placeholder = "Ingrese coreo electrónico" value = {this.state.email} 
                    onChange = {this.updateEmail}/>          

                    <button className="enterEmailBtn">Entregar</button>
...
export default SpanishGetEmail;
