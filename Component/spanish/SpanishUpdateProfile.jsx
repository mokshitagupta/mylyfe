...
import SpanishUpload from "./SpanishUpload.jsx";
import SpanishDelete from "./SpanishDelete.jsx";
...
function BioBox(props){
  ...
  <div className="input-container" id = "minput" >
      <input maxlength={maxBio} id='tell-us' placeholder='Cuéntanos acerca de ti . . .' onChange={calcLen}></input>
...
function getUserData() {
  ...
  const returnPopup = (upload) => {
    console.log(upload)
    return(
    upload ? <SpanishUpload openModal2={openModal2} closeModal={closeModal} onChangeName={(path)=>
    // console.log(`${path}`)
      setProfilePicture(`${path}`)
    } />: <SpanishDelete openModal={openModal} closeModal={closeModal}/>
    )
  }
  ...
  return(
    ...
    <div className="overlay-cont">
      ...
      <img src= {undo} className="undo-img" onClick={back}/>
        <p>¡Hola, {!(userData === null) ? userData.username :"NaN"}! Actualicemos tu perfil:</p>
      </div>
      </div>
      <div className='header-update'>
        <div className="pfp-container" id='update-child'>
          ...
          <div className = "circle-new">
                <img src = {profilePicture} alt = "profile pic" id = "user_image"/>
      ...
      <div className='updateform-container'>
        <div className="input-container" id = "minput">
            ...
            <input id = "change-username" placeholder='Cambie el nombre de usuario'></input>
            <p id = "mparagraph">&nbsp; &nbsp; &nbsp;¡Letras y numeros solamente!</p>
        </div>
        
        <BioBox/>

        <div>
            <button type="submit" className="submit-update" onClick={() => handleSubmit(userData.username)}>¡Guardar cambios!</button>
        </div>
        
        <div id = "delete-div" >
            <button className="delete-update" onClick={openDelete} placeholder='Change Username'>Eliminar cuenta</button>
        </div>
      </div>
    </div>
    </div>
