          ...
          <div className = "body">
              ...
              <div className = "block">
                  ...
                  <div id = {image} className = "profile"> 
                      <UserInfo points = {this.state.points} uploaderID={this.state.uploaderID} ismyprofile={this.state.ismyprofile}/>
                      <div className="profile-err-NotFound">
                          <Alert color="red" text="Forbidden Access"/>
                      </div>
                      ...
                      { (this.state.ismyprofile) ?
                        ...
                        <div>
                          ...
                          <div className = "button-div">
                            ...
                            <BlockButton reload={this.props.reload} uploaderID={this.state.uploaderID} connectionData={this.state.connectionData} connectionID={this.state.connectionID} getConnectionData={this.getConnectionData}/>
                          </div>
                        </div>
                        )
                      }
          ...
          <div className = "body">
              ...
              <div className = "block">
                  ...
                  <div id = {image} className = "profile">
                      <UserInfo points = {this.state.points} uploaderID={this.state.uploaderID} ismyprofile={this.state.ismyprofile}/>
                      <div className="profile-err-NotFound">
                          <Alert color="red" text="You have blocked this user!"/>
                      </div>
                            ...
                            (   <>  
                                  {this.state.addedPoints ? (
                                      <div className="profile-err">
                                          <Alert color="green" text={"You gained 10xp! Come back tomorrow at " + new Date(this.state.currentDate.getTime() + (24 * 60 * 60 * 1000)) + " for more!"} />
                                      </div>
                              ) : ( 
                              <>
                                  </>
        ...
        return (
          <div className = "body">
              <div className = "block">
                  <div id = {image}  className = "profile">
                      <div className="profile-err-NotFound">
                        <Alert color="red" text="No User Found"/>
                      </div>
                      <div className = "button-div">
                        {
                        /*<FollowButton />
        ...
        return (
          <div className = "body">
              <div className = "block">
                  <div id = {image}  className = "profile">
                      <div className="profile-err-NotFound">
                        <Alert color="red" text="Please log in to view profiles"/>
                      </div>
                      <div className = "button-div">
                        {
                        /*<FollowButton />
