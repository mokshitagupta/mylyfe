...
export default function FollowList(props) {
    ...
    const [follow, setFlg] = useState(localStorage.getItem("language") === "espanol" ?"Siguiente" :"Following")
    const [follower, setFlr] = useState(localStorage.getItem("language") === "espanol" ?"Seguidoras" :"Followers")
    ...
    }, [localStorage.getItem("language"), window.location.href])
      ...
      return (
        <div className = "close-list" id = "close-list">
          ...
          {!following ? (
            ...
            <div className = "following-title" id = "following-title">
              {localStorage.getItem("language") === "" ? (<>
                <div className="follow-1b"onClick={() => {setFollowing(false)}}>Following</div>
                <div className="follow-2" onClick={() => {setFollowing(true)}}>Followers</div></>
              ):(<>
                <div className="follow-1b"onClick={() => {setFollowing(false)}}>Seguidos</div>
                <div className="follow-2" onClick={() => {setFollowing(true)}}>Seguidores</div>
              </>)}
            </div>
          ...
          : (
            ...
            <div className = "following-title" id = "following-title">
              {localStorage.getItem("language") === "" ? (<>
                  <div className="follow-1"onClick={() => {setFollowing(false)}}>Following</div>
                  <div className="follow-2b" onClick={() => {setFollowing(true)}}>Followers</div></>
                ):(<>
                  <div className="follow-1"onClick={() => {setFollowing(false)}}>Seguidos</div>
                  <div className="follow-2b" onClick={() => {setFollowing(true)}}>Seguidores</div>
                </>)}
            </div>
